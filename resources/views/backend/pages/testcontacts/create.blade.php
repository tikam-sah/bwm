...
@section('title')
Test Contacts Create - Admin Panel
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Contacts Test Create</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li><a href="{{ route('admin.testcontacts.index') }}">Test Contacts</a></li>
                    <li><span>Create Test Contacts</span></li>
                </ul>
            </div>
        </div>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Create New Test Contacts</h4>
                    @include('backend.layouts.partials.messages')
                    
                    <form action="{{ route('admin.testcontacts.store') }}" method="POST">
                        @csrf
                        <div class="form-row">
                        ...
                        <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4">Save Test Contact</button>
                    </form>
                </div>
            </div>
        </div>
